...
export default function GameMenu({ isOpen, children, title }: GameMenuProps) {
  ...
  return (
    <Overlay isOpen={isOpen}>
      <div className="lg:h-[70%] 2xs:h-[70%] lg:w-[50%] 2xs:w-[80%] bg-white dark:bg-slate-900 rounded-2xl m-auto pt-16 space-y-4 relative text-center font-bold dark:text-violet-500">
